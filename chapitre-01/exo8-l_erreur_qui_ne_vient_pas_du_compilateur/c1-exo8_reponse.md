en compilant avec -c  on observe que la compilation se termine avec succes car dans cette situation le compilateur travaille seul et voir donc que la declaration int calculer () ; suffit pour promettre renvoyer  un entier .
