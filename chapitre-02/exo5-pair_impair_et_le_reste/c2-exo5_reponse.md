...
$ clang++ c2-exo5_main.cpp -o prog

chris@DESKTOP-RSAB6V8 MSYS /c/Users/chris/ani-1071/chapitre-02
$ ./prog
entrer un nombre entier0
...
$ 
```
en conclusion l'utilisation de plusieurs if rend notre raisonnement plus visible et plusieurs résultats sur une même ligne
Or au niveau de l'exécution avec -9 la division n'est pas régulière car nous utilisons notre int qui englobe plusieurs type de donnes c'est pourquoi cela rend divisible par 3.
